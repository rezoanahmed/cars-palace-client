        ...
        <div className="p-4">
            ...
            <div className="flex justify-center">
                <form onSubmit={handleSubmit} className="flex gap-2 flex-col justify-center mt-10">
                    ...
                    {/* Price and Rating */}
                    <div className="flex gap-2">
                        <input type="text" placeholder="Price" className="input input-bordered input-info border-blue-600 w-full max-w-xs" />
                        <input type="text" placeholder="Rating" className="input input-bordered input-info border-blue-600 w-full max-w-xs" />
                    </div>
                    {/* Description */}
                    <div className="flex gap-2">
                        <textarea type="text" placeholder="Write Short Description" className="p-4 h-24 input input-bordered input-info border-blue-600 w-full" />
